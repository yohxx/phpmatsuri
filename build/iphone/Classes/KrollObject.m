...
//@interface phpmatsuriObject : NSObject
//@end

@interface phpmatsuriObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[phpmatsuriObject class]])
		{
			for (NSString *key in [[(phpmatsuriObject*)o modules] allKeys])
			{
