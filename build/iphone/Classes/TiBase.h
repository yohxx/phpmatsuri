...
// in simulator we redefine to format for phpmatsuri Developer console
...
{\
	NSString * exceptionName = [@"org.phpmatsuri." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.phpmatsuri";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIphpmatsuriNativeItemNone = -1, 
	UIphpmatsuriNativeItemSpinner = -2,
	UIphpmatsuriNativeItemProgressBar = -3,
	
	UIphpmatsuriNativeItemSlider = -4,
	UIphpmatsuriNativeItemSwitch = -5,
	UIphpmatsuriNativeItemMultiButton = -6,
	UIphpmatsuriNativeItemSegmented = -7,
	
	UIphpmatsuriNativeItemTextView = -8,
	UIphpmatsuriNativeItemTextField = -9,
	UIphpmatsuriNativeItemSearchBar = -10,
	
	UIphpmatsuriNativeItemPicker = -11,
	UIphpmatsuriNativeItemDatePicker = -12,
	
	UIphpmatsuriNativeItemInfoLight = -13,
	UIphpmatsuriNativeItemInfoDark = -14,
	
	UIphpmatsuriNativeItemDisclosure = -15,
	
	UIphpmatsuriNativeItemContactAdd = -16
};
